        ...
        <div class="container mt-5">
            ...
            <hr>
             ...
             <div id="toolbar" >      
                <div class="row">
                   <div class="col-5 col-12-medium">
                        <a href="fundaciones_form.jsp?accion=nuevo" class="col-sm-2"> <button type="submit" class="btn btn-primary"  id="btnNuevo" >Crear Fundacion</button></a><!-- comment -->                           
                   </div>
             ...
             <!-- tabla de datos cargados desde la base de datos -->
                    ...
                    <table id="tablafundaciones" class="table order-table" data-toolbar="#toolbar" data-toggle="table" data-search="true" data-show-columns="true" data-show-export="true" data-pagination="true" data-page-list="[10, 25, 50]" data-locale="es-SP">
                    <thead>
                        <tr>
                            <th scope="col" data-sortable="true">Id</th>
                            <th scope="col" data-sortable="true">Nombre</th>
                            <th scope="col" data-sortable="true">Dirección</th>
                            <th scope="col" data-sortable="true">Email</th>
                            <th scope="col" data-sortable="true">Representante</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="fundaciones_form.jsp?accion=editar1&id=<%= j.getIdFundacion() %>"<button type="button" class="btn btn-danger"><i class="bi bi-trash"></i></button></a>                              
                            </td>
